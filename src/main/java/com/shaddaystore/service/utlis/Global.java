package com.shaddaystore.service.utlis;

public class Global {/*esta es la clase para las respuestas*/
    public enum Estado {
        A,
        I
    }
    ...
    public static final String OPERACION_CORRECTA = "Operación finalizada con éxito.";
    public static final String OPERACION_INCORRECTA = "No se realizó la operación.";
